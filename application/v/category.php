	...
	<script type="text/javascript">
		...
		function addCategory() {
			...
			var categoryNameLang = $('#category-name-lang-add').val();
		...
		function editCategory() {
			...
			var categoryNameLang = $('#category-name-lang-edit').val();
			...
			$.ajax({
				...
				success: function(data){
					if (data.status == 'success') {
						...
						$('#category-name-lang-edit').val(data.category.name_lang);
						...
						<? if ($setting->setting__website_enabled_dual_language > 0): ?>
							<div class="two fields">
								...
								<div class="field">
									...
									<input id="category-name-lang-add" type="text" class="data-important-add" placeholder="Name..">
								</div>
							</div>
						<? else: ?>
							<div class="field">
					...
					<div class="ui form">
						<? if ($setting->setting__website_enabled_dual_language > 0): ?>
							<div class="two fields">
								...
								<div class="field">
									<label>Name - <?= $setting->setting__system_language2; ?> <span class="color-red warning"></span></label>
									<input id="category-name-lang-edit" class="data-important-edit" placeholder="Name..">
								</div>
							</div>
						<? else: ?>
							<div class="field">
