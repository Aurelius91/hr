	...
	<script type="text/javascript">
		...
		function reset() {
			...
			$('#user-religion').val("");
			$('#user-religion-container').dropdown('set selected', "");

			$('#user-status').val("");
			$('#user-status-container').dropdown('set selected', "");

			$('#user-absence-number').val("");
			$('#user-username').val("");
			$('#user-password').val("");

			$('#user-departmant').val("0");
			$('#user-departmant-container').dropdown('set selected', "0");
		...
		function submit() {
			...
			var userDepartmentId = $('#user-departmant').val();
						...
						<div class="field">
							...
							<div class="three fields">
								<div class="field">
									...
									<div id="user-departmant-container" class="ui search selection dropdown form-input">
										<input id="user-departmant" type="hidden">
