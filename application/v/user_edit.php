	...
	<script type="text/javascript">
		...
		function init() {
			...
			$('#user-birthday, #user-date-in').datepicker({
				changeMonth: true,
      			changeYear: true,
                dateFormat: 'yy-mm-dd',
            });
		...
		function reset() {
			$('#user-nip').val("<?= $user->nip; ?>");
			$('#user-name').val("<?= $user->name; ?>");
			$('#user-position').val("<?= $user->position; ?>");
			$('#user-address').val("<?= $user->address; ?>");
			$('#user-phone').val("<?= $user->phone; ?>");

			$('#user-ktp').val("<?= $user->ktp; ?>");
			$('#user-npwp').val("<?= $user->npwp; ?>");
			$('#user-birthday').val("<?= $user->birthday_display; ?>");
			$('#user-date-in').val("<?= $user->date_in_display; ?>");

			$('#user-religion').val("<?= $user->religion; ?>");
			$('#user-religion-container').dropdown('set selected', "<?= $user->religion; ?>");

			$('#user-status').val("<?= $user->status; ?>");
			$('#user-status-container').dropdown('set selected', "<?= $user->status; ?>");

			$('#user-absence-number').val("<?= $user->absence_number; ?>");
			$('#user-email').val("<?= $user->email; ?>");
			$('#user-username').val("<?= $user->username; ?>");

			$('#user-department').val("<?= $user->department_id; ?>");
			$('#user-department-container').dropdown('set selected', "<?= $user->department_id; ?>");
		...
		function submit() {
			var userNip = $('#user-nip').val();
			var userName = $('#user-name').val();
			var userPosition = $('#user-position').val();
			var userAddress = tinyMCE.get('user-address').getContent();
			var userPhone = $('#user-phone').val();
			var userEmail = $('#user-email').val();
			var userKtp = $('#user-ktp').val();
			var userNpwp = $('#user-npwp').val();
			var userBirthday = $('#user-birthday').val();
			var userDateIn = $('#user-date-in').val();
			var userReligion = $('#user-religion').val();
			var userStatus = $('#user-status').val();
			var userAbsenceNumber = $('#user-absence-number').val();
			var userUsername = $('#user-username').val();
			var userPassword = $('#user-password').val();
			var userDepartmentId = $('#user-department').val();
			...
			$.ajax({
				data :{
					...
					date_in: userDateIn,
					absence_number: userAbsenceNumber,
					status: userStatus,
					...
					<div class="ui form">
						...
						<div class="field">
							<div class="three fields">
								<div class="field">
									<label>NIP <span class="color-red">*</span></label>
									<input id="user-nip" class="form-input data-important" placeholder="NIP.." type="text">
								</div>
								<div class="field">
							...
							<div class="three fields">
								<div class="field">
									...
									<div id="user-department-container" class="ui search selection dropdown form-input">
										<input id="user-department" type="hidden">
										<i class="dropdown icon"></i>
										<div class="default text">-- Select Department --</div>
										<div class="menu">
											<div class="item" data-value="0">All Department</div>
								...
								<div class="field">
									...
									<div id="user-status-container" class="ui search selection dropdown form-input">
										<input id="user-status" type="hidden">
										<i class="dropdown icon"></i>
										<div class="default text">-- Select Status --</div>
										<div class="menu">
											<div class="item" data-value="Probation">Probation</div>
											<div class="item" data-value="Contract">Contract</div>
											<div class="item" data-value="Permanent Employee">Permanent Employee</div>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="three fields">
								<div class="field">
									<label>KTP</label>
									<input id="user-ktp" class="form-input" placeholder="KTP.." type="text">
								</div>
								<div class="field">
									<label>NPWP</label>
									<input id="user-npwp" class="form-input" placeholder="NPWP.." type="text">
								</div>
								<div class="field">
									<label>Religion</label>
									<div id="user-religion-container" class="ui search selection dropdown form-input">
										<input id="user-religion" type="hidden">
										<i class="dropdown icon"></i>
										<div class="default text">-- Select Religion --</div>
										<div class="menu">
											<div class="item" data-value="Moslem">Moslem</div>
											...
											<div class="item" data-value="Kong Hu Cu">Kong Hu Cu</div>
											<div class="item" data-value="Hindu">Hindu</div>
										</div>
									</div>
								</div>
							...
							<div class="two fields">
								<div class="field">
									...
									<input id="user-birthday" class="form-input" placeholder="Birthday.." type="text">
								</div>
								<div class="field">
									<label>Date In</label>
									<input id="user-date-in" class="form-input" placeholder="Date In.." type="text">
								</div>
							</div>
						</div>
						...
						<div class="field">
							<div class="three fields">
								<div class="field">
									...
									<input id="user-absence-number" class="form-input" placeholder="Absence ID.." type="text">
								</div>
								<div class="field">
